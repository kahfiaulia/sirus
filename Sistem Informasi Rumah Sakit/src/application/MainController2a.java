...
public class MainController2a implements Initializable{
	@FXML
	...
	@FXML
	public void Pegawai(ActionEvent event) throws IOException{
	...
	public void Ubah(ActionEvent event) throws IOException{
        ...
        try{    
            	...
            	FXMLLoader loader = new FXMLLoader(getClass().getResource("ubahdataa.fxml"));
            	Parent root = (Parent) loader.load();
            	MainController4a secController = loader.getController();
...
//            	secController.setTglKeluar1(selectedItem.getKeluar().toString());
	...
	public void Tambah(ActionEvent event) throws IOException{
        ...
        try{       	
            	Parent halamanUtamaParent = FXMLLoader.load(getClass().getResource("/application/tambahdataa.fxml"));
    			Scene halamanUtamaScene = new Scene (halamanUtamaParent);
    			Stage app_stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
    			app_stage.setTitle("Sistem Informasi Rumah Sakit Terpadu");
    			app_stage.setMaximized(true);
